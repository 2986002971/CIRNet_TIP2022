...
parser.add_argument(
    "--decay_rate", type=float, default=0.2, help="decay rate of learning rate"
)
parser.add_argument(
...
parser.add_argument(
    "--rgb_root",
    type=str,
    default="data/RGBD_for_train/RGB/",
    help="the training rgb images root",
)
parser.add_argument(
    "--depth_root",
    type=str,
    default="data/RGBD_for_train/depth/",
    help="the training depth images root",
)
parser.add_argument(
    "--gt_root",
    type=str,
    default="data/RGBD_for_train/GT/",
...
parser.add_argument(
    "--test_path", type=str, default="./data/RGBD_for_test/", help="test dataset path"
)
parser.add_argument(
    "--test_model",
    type=str,
    default="CIRNet_R50.pth",
